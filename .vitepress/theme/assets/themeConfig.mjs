  ...
  footer: {
    ...
    sitemap: [
      ...
      },
      {
        text: "项目",
        items: [
          { text: "网站导航", link: "https://czhweb.us.kg/", newTab: true },
          { text: "无", link: "", newTab: true },
          { text: "无", link: "", newTab: true },
          { text: "无", link: "", newTab: true },
        ],
      },
      ...
      },
      {
        text: "服务",
        items: [
          { text: "站点状态", link: "https://czhzeta.us.kg/", newTab: true },
          { text: "一个导航", link: "https://czhweb.us.kg/", newTab: true },
        ],
      },
    ],
  },
